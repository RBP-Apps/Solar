...
export default function Button({
  ...
  const variants = {
    primary: 'bg-primary text-white hover:bg-primary-hover shadow-sm hover:shadow-md border border-primary/20',
    secondary: 'bg-secondary text-white hover:bg-secondary-hover shadow-sm hover:shadow-md',
    accent: 'bg-accent text-slate font-semibold hover:bg-accent-hover shadow-sm hover:shadow-md',
    outline: 'border border-primary text-primary hover:bg-primary hover:text-white',
    ghost: 'text-primary hover:bg-primary/5 hover:text-primary-hover',
    white: 'bg-white text-primary hover:bg-slate-50 shadow-sm hover:shadow-md border border-slate-200'
  };
